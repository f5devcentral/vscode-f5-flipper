 ...
 *
 * LEGACY IMPLEMENTATION - Uses original array-based parsing
 * Preserved for performance comparison and validation
 *
 * @deprecated Use CitrixADC.ts (new RX-based implementation) instead
 */
export default class ADCold extends EventEmitter {
    /**
    ...
    async apps() {
        ...
        // dig each 'add cs vserver' - array-based parser
        ...
        // dig each 'add lb vserver', but check for existing? - array-based parser
